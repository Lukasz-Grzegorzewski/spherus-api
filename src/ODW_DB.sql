-- Active: 1675682828381@@127.0.0.1@3306@spherus-db
...
-- Schema spherus-db
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `spherus-db` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci ;
USE `spherus-db` ;

-- -----------------------------------------------------
-- Table `spherus-db`.`category`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spherus-db`.`category` ;

CREATE TABLE IF NOT EXISTS `spherus-db`.`category` (
...
-- -----------------------------------------------------
-- Table `spherus-db`.`home`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spherus-db`.`home` ;

CREATE TABLE IF NOT EXISTS `spherus-db`.`home` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
INSERT INTO
  `spherus-db`.`home` (position, type, idLink )
VALUES
  ( '1', '1', '1' ),
  ( '3', '1', '3' ),
  ( '2', '2', '1' );
...
-- -----------------------------------------------------
-- Table `spherus-db`.`video_carousel`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spherus-db`.`video_carousel` ;

CREATE TABLE IF NOT EXISTS `spherus-db`.`video_carousel` (
  ...
  CONSTRAINT `fk_home_id`
    FOREIGN KEY (`home_id`)
    REFERENCES `spherus-db`.`home` (`id`),
  CONSTRAINT `fk_video_carousel_id`
    FOREIGN KEY (`video_carousel_id`)
    REFERENCES `spherus-db`.`video` (`id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;

INSERT INTO
  `spherus-db`.`video_carousel` (video_carousel_id, home_id )
VALUES
  ( '1', '1' ),
  ( '6', '1' ),
  ( '5', '1' ),
...
-- -----------------------------------------------------
-- Table `spherus-db`.`user`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spherus-db`.`user` ;

CREATE TABLE IF NOT EXISTS `spherus-db`.`user` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
INSERT INTO
  `spherus-db`.`user` (url, firstname, lastname, nickname, birthday, email, password, is_admin, token, token_start)
VALUES
  (
    ...
    '2000-01-01',
    'admin@admin.com',
    '$argon2id$v=19$m=65536,t=5,p=1$j2+ir4t+Cr2/WDROODBT8w$Q6yVqTTh2bsKwHJeCrFZmyXANVQDijxRgjJCpn5MCZE',
    1,
    'token_2',
    '2022-12-01'
  ),
...
-- -----------------------------------------------------
-- Table `spherus-db`.`video`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spherus-db`.`video` ;

CREATE TABLE IF NOT EXISTS `spherus-db`.`video` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
INSERT INTO
  `spherus-db`.`video` (url, description, display, title, date)
VALUES
  (
...
-- -----------------------------------------------------
-- Table `spherus-db`.`favorites`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spherus-db`.`favorites` ;

CREATE TABLE IF NOT EXISTS `spherus-db`.`favorites` (
...
-- -----------------------------------------------------
-- Table `spherus-db`.`display_fixtures`
-- -----------------------------------------------------

DROP TABLE IF EXISTS `spherus-db`.`display_fixtures` ;

CREATE TABLE IF NOT EXISTS `spherus-db`.`display_fixtures` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
INSERT INTO
  `spherus-db`.`display_fixtures` (name)
VALUES
  ( 'Popular videos' );

-- -----------------------------------------------------
-- Table `spherus-db`.`fixtures`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spherus-db`.`fixtures` ;

CREATE TABLE IF NOT EXISTS `spherus-db`.`fixtures` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
INSERT INTO
  `spherus-db`.`fixtures` (fk_fix_video_id)
VALUES
  ( '2' ),
  ( '18' ),
  ( '8' ),
...
-- -----------------------------------------------------
-- Table `spherus-db`.`hero_slider`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spherus-db`.`hero_slider` ;

CREATE TABLE IF NOT EXISTS `spherus-db`.`hero_slider` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
INSERT INTO
  `spherus-db`.`hero_slider` (fk_video)
VALUES
('16'),
('14'),
('6');
...
-- -----------------------------------------------------
-- Table `spherus-db`.`publicity`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spherus-db`.`publicity` ;

CREATE TABLE IF NOT EXISTS `spherus-db`.`publicity` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
INSERT INTO
  `spherus-db`.`publicity` (url_image, description, url_link, name)
VALUES
  (
...
-- -----------------------------------------------------
-- Table `spherus-db`.`video_category`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spherus-db`.`video_category` ;

CREATE TABLE IF NOT EXISTS `spherus-db`.`video_category` (
  ...
  CONSTRAINT `fk_category_id`
    ...
    REFERENCES `spherus-db`.`category` (`id`),
...
INSERT INTO
  `spherus-db`.`video_category` (video_id, category_id)
VALUES
  ( 1, 1 ),
  ( 1, 2 ),
  ( 1, 3 ),
